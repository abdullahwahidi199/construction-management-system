export const REPORTS = {
  projects: {
    ...
    columns: [
      ...
      { key: "employee_payroll_usd", label: "Employee Payroll USD", type: "currency" },
      { key: "employee_payroll_afn", label: "Employee Payroll AFN", type: "currency" },
  ...
  payroll: {
    ...
    filters: [
      ...
      { name: "project_id", label: "Project ID", type: "number" },
      {
        ...
        type: "select",
        options: [
          { value: "", label: "All Payroll" },
          { value: "PROJECT", label: "Project Payroll" },
    ...
    columns: [
      ...
      { key: "payroll_classification", label: "Classification", type: "badge" },
      ...
      { key: "advance_deductions", label: "Advance Deductions", type: "number" },
      ...
      { key: "amount_paid", label: "Paid", type: "number" },
      { key: "balance_due", label: "Balance", type: "number" },
      { key: "cash_outflow", label: "Cash Outflow", type: "number" },
      { key: "status", label: "Status", type: "badge" },
    ],
  },
  ...
  employees: {
    ...
    filters: [
      ...
      },
      {
        ...
        options: [
          { value: "", label: "All Types" },
          { value: "PROJECT", label: "Project Employee" },
